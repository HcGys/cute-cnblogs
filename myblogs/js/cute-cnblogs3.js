...
function miluframe(setting) {
  var c = {
    ...
    resume: {
      ...
      link: "https://www.cnblogs.com/miluluyo/",
      headurl:
        "https://images.cnblogs.com/cnblogs_com/elkyo/1558759/o_o_my.jpg",
    ...
    logoimg:
      "https://images.cnblogs.com/cnblogs_com/miluluyo/1765646/o_200519070633f12.png",
    cuteicon: [
      "icon-caomei",
      "icon-boluo",
      "icon-huolongguo",
...
function allpage(c) {
  ...
  var skin =
    '<div class="select_skin"><ul><li class="light_white">浅白色系</li><li class="furvous">暗黑色系</li><li class="reading">阅读模式</li></ul></div>';
  tippy(".skin_btn", {
    content: skin,
    theme: "tomato",
    allowHTML: true,
  ...
  for (var i = 0; i < newarray.length; i++) {
    listfriends =
      listfriends +
      '<div class="unionbox"><div class="info"><div class="headimg"><img src="' +
      newarray[i].headurl +
      '" alt=""></div><div class="content"><h3 class="title">' +
      newarray[i].name +
      '</h3><p class="desc">' +
      newarray[i].introduction +
      '</p><a class="btn" target="_black" href="' +
      newarray[i].url +
      '">直达</a></div></div></div>';
  }
...
//   $(".feedbackCon")
//     .eq(i)
//     .prepend('<img class="comment-avatar" src="' + $.trim(src) + '">');
// }
...
var load_face = function (a) {
  var OwO_demo = new OwO({
    ...
    api: "https://cdn.staticaly.com/gh/HcGys/DataSource@main/json/owo_cnblogs.json",
    position: "down",
    width: "70%",
    maxHeight: "250px",
  });
...
jQuery(document).ready(function($) {
  ...
  window.addEventListener('scroll', function (e) {
    ...
    if (t > pic.offsetHeight +  poem.offsetHeight) {
      ...
      sidebar.setAttribute('style', 'position: fixed; top: 0.1em; right: 7em;')
...
function GenerateContentList() {
  ...
  content +=
    '<p style="font-size:18px;text-align: center;padding-bottom: 10px;"><b>阅读目录(Content)</b></p>';
  content += '<ul class="first_class_ul">';
  for (var i = 0; i < jquery_h1_list.length; i++) {
    var go_to_top =
      '<div style="text-align: right" class="_labBox"><a name="_label' +
      i +
      '" id="_label' +
      i +
      '"></a></div>';
    ...
    var jquery_h2_list = $(jquery_h1_list[i]).nextUntil(
      jquery_h1_list[nextH1Index],
      "h2"
    );
    ...
    for (var j = 0; j < jquery_h2_list.length; j++) {
      var go_to_top2 =
        '<div style="text-align: right" class="_labBox"><a name="_lab2_' +
        i +
        "_" +
        j +
        '" id="_lab2_' +
      ...
      for (var k = 0; k < jquery_h3_list.length; k++) {
        var go_to_third_Content =
          '<div style="text-align: right" class="_labBox"><a name="_label3_' +
          i +
          "_" +
          j +
          "_" +
...
console.info(
  "%c ",
  "background: url(https://images.cnblogs.com/cnblogs_com/blogs/794412/galleries/2313394/o_230528124945_o_a.gif) no-repeat center;padding-left:400px;padding-bottom: 160px;background-size:400px"
);
var h =
  "" +
  "               __                                ___.   .__                       \n" +
