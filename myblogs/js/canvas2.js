...
class ThumbsUpAni {
    ...
    loadImages() {
        const images = [
            'o_230528124945_o_200522031835like1.png',
            'o_230528124945_o_200522031842like2.png',
            'o_230528124945_o_200522031850like3.png',
            'o_230528124945_o_200522031859like4.png',
            'o_230528124945_o_200522031907like5.png',
            'o_230528124945_o_200522031915like6.png'
        ];
        const promiseAll = [];
        images.forEach((src) => {
            const p = new Promise(function (resolve) {
                ...
                img.src = 'https://images.cnblogs.com/cnblogs_com/blogs/794412/galleries/2313394' + src;
            });
            promiseAll.push(p);
        });
